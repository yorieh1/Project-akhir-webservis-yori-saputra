...
<div class="card card-primary">
    ...
    <form action="{{ route('kas-masjid.update.pengeluaran',$kasMasjid->id_masjid) }}" method="POST">
        @csrf
        @method('patch')
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="keluar" name="keluar" value="{{$kasMasjid->keluar}}" placeholder="Jumlah Pengeluaran" required>
                </div>
            </div>
