...
<div class="card card-primary">
    ...
    <form action="{{ route('kas-sosial.update',$kasSosial->id) }}" method="POST">
        @csrf
        @method('patch')
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" id="masuk" name="masuk" value="{{$kasSosial->masuk}}" placeholder="Jumlah Pemasukan" required>
                </div>
            </div>
