...
<div class="card card-primary">
    ...
    <form action="{{ route('kas-masjid.store.pengeluaran') }}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="urain_kas_masjid" name="urain_kas_masjid" placeholder="Uraian Pengeluaran" required>
                </div>
            </div>
