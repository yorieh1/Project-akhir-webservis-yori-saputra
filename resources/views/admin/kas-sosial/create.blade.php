...
<div class="card card-primary">
    ...
    <form action="{{ route('kas-sosial.store') }}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="urain_kas_sosial" name="uraian" placeholder="Uraian Pemasukan" required>
                </div>
            </div>
